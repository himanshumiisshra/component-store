...
import { Articles } from '../profile/articles/articles.component';
import {
  ApiClient,
  Article,
  Comment,
...
import { ApiStatus, CommentWithOwner } from '../shared/data-access/model';
...
export class ArticleStore extends ComponentStore<ArticleState> {
  ...
  // readonly getArticle = createEffect()
